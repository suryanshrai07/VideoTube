    ...
    <div onClick={handleVideoClick} className="cursor-pointer group">
      ...
      <div className="flex flex-col gap-3 md:gap-0">
        ...
        <div className="relative bg-gray-800 rounded-lg md:rounded-xl overflow-hidden shrink-0 w-full aspect-video">
          ...
          {duration && (
            <div className="absolute bottom-1 right-1 md:bottom-2 md:right-2 bg-black bg-opacity-80 text-white text-xs font-semibold px-1.5 py-0.5 md:px-2 md:py-1 rounded">
        ...
        {/* Video Meta Section */}
        <div className="flex gap-2 md:gap-3 md:mt-3 ">
